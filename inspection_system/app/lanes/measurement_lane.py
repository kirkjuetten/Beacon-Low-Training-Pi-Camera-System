...
from inspection_system.app.inspection_models import LaneResult
...
def execute_measurement_lane(
    ...
    *,
    ...
    return LaneResult(
        ...
        inspection_cfg=deepcopy(lane_inspection_cfg),
        measurement_result=deepcopy(measurement_result),
