...
class ConfigEditorPage:
    ...
    def _build_layout(self) -> None:
        ...
        self.refresh_preview_button = ttk.Button(preview_buttons, text="Refresh Preview", command=self.refresh_live_preview)
        self.refresh_preview_button.grid(row=0, column=0, sticky="ew", padx=(0, 4))
        self.refresh_view_button = ttk.Button(preview_buttons, text="Refresh View", command=self.refresh_view)
    ...
    def _refresh_live_preview_thread(self) -> None:
        ...
        def finish() -> None:
            if result_code == 0:
                self.set_busy(False, "Live preview updated")
            else:
